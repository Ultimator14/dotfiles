...
# Changed settings are marked with !!CHANGED!!
local ICON_EMPTY_CIRCLE='󰝦'
local ICON_FULL_CIRCLE='󰝥'
local ICON_ARROW_UP=''
local ICON_ARROW_DOWN=''
local ICON_ARROW_LEFT=''
local ICON_ARROW_RIGHT=''
local ICON_CROSS='✖'

# Generated by Powerlevel10k configuration wizard on 2024-07-28 at 13:35 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
	...
	# nordvpn                 # nordvpn connection status, linux only (https://nordvpn.com/) !!CHANGED!! (commented)
  ...
  # Don't shorten this many last directory segments. They are anchors. !!CHANGED!! (was 1)
  ...
  # Change the value of this parameter to show a different icon. !!CHANGED!! (was ?)
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_ICON='󰇘'
  ...
  function my_git_formatter() {
    ...
    if (( VCS_STATUS_COMMITS_AHEAD || VCS_STATUS_COMMITS_BEHIND )); then
      # ⇣42 if behind the remote. !!CHANGED!! (was ⇣)
      (( VCS_STATUS_COMMITS_BEHIND )) && res+=" ${clean}${ICON_ARROW_DOWN}${VCS_STATUS_COMMITS_BEHIND}"
	  # ⇡42 if ahead of the remote; no leading space if also behind the remote: ⇣42⇡42. !!CHANGED!! (was ⇡)
      (( VCS_STATUS_COMMITS_AHEAD && !VCS_STATUS_COMMITS_BEHIND )) && res+=" "
      (( VCS_STATUS_COMMITS_AHEAD  )) && res+="${clean}${ICON_ARROW_UP}${VCS_STATUS_COMMITS_AHEAD}"
    elif [[ -n $VCS_STATUS_REMOTE_BRANCH ]]; then
      # Tip: Uncomment the next line to display '=' if up to date with the remote.
      # res+=" ${clean}="
    fi

	# ⇠42 if behind the push remote. !!CHANGED!! (was ⇠)
    (( VCS_STATUS_PUSH_COMMITS_BEHIND )) && res+=" ${clean}${ICON_ARROW_LEFT}${VCS_STATUS_PUSH_COMMITS_BEHIND}"
    (( VCS_STATUS_PUSH_COMMITS_AHEAD && !VCS_STATUS_PUSH_COMMITS_BEHIND )) && res+=" "
    # ⇢42 if ahead of the push remote; no leading space if also behind: ⇠42⇢42. !!CHANGED!! (was ⇢)
    (( VCS_STATUS_PUSH_COMMITS_AHEAD  )) && res+="${clean}${ICON_ARROW_RIGHT}${VCS_STATUS_PUSH_COMMITS_AHEAD}"
    # *42 if have stashes.
    (( VCS_STATUS_STASHES        )) && res+=" ${clean}*${VCS_STATUS_STASHES}"
    # 'merge' if the repo is in an unusual state.
    [[ -n $VCS_STATUS_ACTION     ]] && res+=" ${conflicted}${VCS_STATUS_ACTION}"
	# ~42 if have merge conflicts. !!CHANGED!! (was ~)
    (( VCS_STATUS_NUM_CONFLICTED )) && res+=" ${conflicted}${ICON_CROSS}${VCS_STATUS_NUM_CONFLICTED}"
	# +42 if have staged changes. !!CHANGED!! (was +)
    (( VCS_STATUS_NUM_STAGED     )) && res+=" ${modified}${ICON_FULL_CIRCLE}${VCS_STATUS_NUM_STAGED}"
	# !42 if have unstaged changes.  !!CHANGED!! (was !)
    (( VCS_STATUS_NUM_UNSTAGED   )) && res+=" ${modified}${ICON_EMPTY_CIRCLE}${VCS_STATUS_NUM_UNSTAGED}"
  ...
  # it will signify success by turning green. !!CHANGED!! (was 2 0)
  ...
  ##################################[ context: user@hostname ]##################################
  # Context color when running with privileges. !!CHANGED!! (was 1 0)
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND=0
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_BACKGROUND=1
  # Context color in SSH without privileges. !!CHANGED!! (was 3 and 0)
  ...
  # Default context color (no privileges, no SSH). !!CHANGED!! (was 3 0)
  ...
  ###[ virtualenv: python virtual environment (https://docs.python.org/3/library/venv.html) ]###
  # Python virtual environment color. !!CHANGED!! (was 0 4)
  ...
  #####################[ anaconda: conda environment (https://conda.io/) ]######################
  # Anaconda environment color. !!CHANGED!! (was 0 4)
